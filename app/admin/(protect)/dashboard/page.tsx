    ...
    return (
        <div className="flex flex-1 flex-col gap-6">
            <div className="rounded-xl bg-gradient-to-r from-red-600 to-orange-600 p-6 text-white">
                ...
                <p className="mt-2 text-red-100">Here's an overview of the platform's performance today.</p>
            </div>
                ...
                <div className="rounded-xl border bg-card p-6 shadow-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium">New recruiter application: TechCorp Inc.</p>
