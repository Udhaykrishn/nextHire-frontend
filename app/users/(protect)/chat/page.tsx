                    ...
                    <div className="p-3 bg-muted/50 border-l-2 border-blue-600 cursor-pointer">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground truncate">Looking forward to meeting you...</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 hover:bg-muted/30 cursor-pointer border-b">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground truncate">Thank you for your application...</p>
                            </div>
                    ...
                    <div className="p-3 hover:bg-muted/30 cursor-pointer border-b">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground truncate">Congratulations! We are pleased to...</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 hover:bg-muted/30 cursor-pointer border-b">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground truncate">Could you please share your...</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex-1 rounded-xl border bg-card flex flex-col">
                ...
                <div className="flex-1 overflow-auto p-4 space-y-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            <div className="bg-muted rounded-lg rounded-tl-none p-3 max-w-md">
                                <p className="text-sm">Hi! Thank you for applying to Google for the Senior Frontend Developer position.</p>
                            </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            <div className="bg-muted rounded-lg rounded-tl-none p-3 max-w-md">
                                <p className="text-sm">We've reviewed your profile and would love to schedule an interview with you. Are you available on December 10th at 3:00 PM IST?</p>
                            </div>
                    ...
                    <div className="flex gap-3 justify-end">
                        <div>
                            <div className="bg-blue-600 text-white rounded-lg rounded-tr-none p-3 max-w-md">
                                <p className="text-sm">Hello! Thank you so much for considering my application. I'm very excited about the opportunity!</p>
                            </div>
                    ...
                    <div className="flex gap-3 justify-end">
                        <div>
                            <div className="bg-blue-600 text-white rounded-lg rounded-tr-none p-3 max-w-md">
                                <p className="text-sm">Yes, December 10th at 3:00 PM IST works perfectly for me. Looking forward to the interview!</p>
                            </div>
                            <p className="text-xs text-muted-foreground mt-1 text-right">10:46 AM</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            <div className="bg-muted rounded-lg rounded-tl-none p-3 max-w-md">
                                <p className="text-sm">Looking forward to meeting you! You'll receive a calendar invite shortly with the meeting link. 🎉</p>
                            </div>
