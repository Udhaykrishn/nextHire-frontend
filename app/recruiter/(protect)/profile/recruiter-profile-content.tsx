...
export function RecruiterProfileContent({
  recruiter,
}: RecruiterProfileContentProps) {
  return (
        ...
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            {recruiter?.description ||
              "No description provided yet. Add a short bio to let candidates know about your company."}
          </p>
        </div>
      </Slot>
        ...
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex items-center gap-4 p-4 rounded-lg bg-muted/30 border border-border flex-1">
              <div
                className={`h-12 w-12 rounded-full flex items-center justify-center ${recruiter?.is_verified_company ? "bg-blue-100 text-blue-600" : "bg-gray-100 text-gray-500"}`}
              >
            ...
            <div className="flex items-center gap-4 p-4 rounded-lg bg-muted/30 border border-border flex-1">
              <div
                className={`h-12 w-12 rounded-full flex items-center justify-center ${recruiter?.subscription?.current_plan === "premium" ? "bg-amber-100 text-amber-600" : "bg-slate-100 text-slate-600"}`}
              >
