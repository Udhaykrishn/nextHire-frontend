...
export function RecruiterDetailsModal({ recruiter, open, onOpenChange }: RecruiterDetailsModalProps) {
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                <Badge
                                    ...
                                    className={recruiter.status === 'active' ? 'bg-green-100 text-green-700 hover:bg-green-100' : ''}
                                >
                                    {recruiter.status}
                                </Badge>
                            </div>
                    ...
                    <div className="grid gap-4">
                        ...
                        <div className="flex items-start gap-3 p-4 rounded-lg border bg-muted/50">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-base font-medium">{recruiter.company_name}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-4 rounded-lg border bg-muted/50">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-base font-medium capitalize">{recruiter.status}</p>
                            </div>
                        </div>
                    </div>
                </div>
