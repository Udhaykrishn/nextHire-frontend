                ...
                <>
                    ...
                    <div className="flex gap-1.5 w-full">
                        {[0, 1, 2, 3, 4].map((index) => (
                            <div
                                key={index}
                                className={`h-1 rounded-full w-full transition-all duration-300 ${getStrengthColor(
                                    index
                                )}`}
                            />
                        ))}
                    ...
                    <div className="flex justify-between items-center text-xs">
                        <span className="text-muted-foreground font-medium">Must contain:</span>
                        ...
                        {calculateStrength.requirements.map((req, index) => (
                            <li key={index} className="flex items-center gap-2">
                                {req.met ? (
                                    ...
                                    <X size={14} className="text-muted-foreground/60 flex-shrink-0" />
                                )}
                                <span
