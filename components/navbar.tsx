                            ...
                            <div className="relative hidden md:block">
                                ...
                                {profileMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-56 rounded-xl border bg-white shadow-lg p-1">
                                        ...
                                        <Link href="/profile" className="flex items-center gap-2 px-4 py-2.5">
                    ...
                    <div className="space-y-1 px-4 pb-4 pt-2">
                        {!isAuthenticated ? (
                            <div className="mt-4 space-y-3 border-t pt-4">
                                <Link href="/login" className="block text-center">Employer Login</Link>
                            ...
                            <div className="mt-4 space-y-2 border-t pt-4">
                                ...
                                <Link href="/profile" className="flex px-3 py-2">My Profile</Link>
                                <Link href={user?.role === "admin" ? "/admin/dashboard" : "/users/dashboard"} className="flex px-3 py-2">
                                    Dashboard
                                </Link>

                                <button
                                    onClick={handleLogout}
                                    className="flex w-full items-center gap-2 px-3 py-2 text-red-600"
                                >
                                    Logout
                                </button>
                            </div>
