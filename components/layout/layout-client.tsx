      ...
      <Sidebar collapsible="icon">
        <SidebarHeader>
          <div className="flex items-center gap-2 px-2 py-2">
            <div
              className={`flex aspect-square size-8 items-center justify-center rounded-lg bg-gradient-to-br ${logoColor} text-white`}
            >
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <Avatar className="h-8 w-8 rounded-lg">
                      ...
                      />
                      <AvatarFallback
                        className={`rounded-lg bg-gradient-to-br ${logoColor} text-white`}
                      >
